...
Directions:
	...
	completely on it's own. It begins by running the training data set, and when it completes, it runs the testing
	data set.

	All relevant information is printed out to the console.
